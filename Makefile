...
#     AUTHOR => q[Nathan Wiger (nate@wiger.org)]
#     NAME => q[SQL::Abstract]
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "    - Nathan Wiger (nate@wiger.org)" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <AUTHOR>Nathan Wiger (nate@wiger.org)</AUTHOR>" >> $(DISTNAME).ppd
